...
class PromdiId extends StatefulWidget {
  @override
  State<PromdiId> createState() => _PromdiIdState();
}

class _PromdiIdState extends State<PromdiId> {
  int ninjalevel = 0;
